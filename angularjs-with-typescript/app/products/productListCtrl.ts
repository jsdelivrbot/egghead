module app.productList {
  ...
  class ProductListCtrl implements IProductListModel {
    ...
    constructor() {
      ...
      var newProduct = new app.domain.Product(3, 'Saw', 'TBX-002', new Date(2002, 3, 1), 16.95, '15-inch steel blade hand saw', 'http://openclipart.org/image/30px/svg_to_png/27070/egore911_saw.png')
